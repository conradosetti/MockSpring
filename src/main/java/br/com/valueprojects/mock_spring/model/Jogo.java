...
public class Jogo {
	...
	public Participante getVencedor() {
		Resultado resultadoComMaiorMetrica = resultados.get(0);

		for(Resultado resultado : resultados) {
			if(resultado.getMetrica() > resultadoComMaiorMetrica.getMetrica()) {
				resultadoComMaiorMetrica = resultado;
			}
		}

		return resultadoComMaiorMetrica.getParticipante();
	}
